...
public class Salary {
	private int basicSalary,epf,companyPf,gratuity;
	private int hra,conveyenceAllowance,otherAllowance,personalAllowance;
	private int monthlyTax,grossSalary,netSalary;
	public Salary(){}
	...
	public Salary(int basicSalary, int epf, int companyPf, int hra,
			int conveyenceAllowance, int otherAllowance, int personalAllowance,
			int monthlyTax, int grossSalary, int netSalary) {
		super();
		this.basicSalary = basicSalary;
		this.epf = epf;
		this.companyPf = companyPf;
	...
	public Salary(int basicSalary,int gratuity, int epf, int companyPf) {
		super();
		this.basicSalary = basicSalary;
		this.epf = epf;
		this.companyPf = companyPf;
